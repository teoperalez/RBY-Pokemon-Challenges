...
export default function Home( {challenge, pokedex}) {
  ...
  return (
    <div className={styles.container}>
      ...
      <label className={styles.radiolabel} for="pokedex">   Full Pokedex  </label>
      <input type="radio" id="challenge" name="pokemon_list" value="challenge" onChange={handleRadio} />
      <label className={styles.radiolabel} for="challenge">  Challenge Pokemon  </label><br />
    ...
    <input className={styles.search} placeholder="Search by Name" type="text" onChange={handleChange}/>
